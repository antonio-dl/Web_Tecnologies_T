...
import dao.TeatroSpettacoloMappingDAO;
...
public class DAOTest {
	...
	public static void main(String[] args) {
		...
		sp.setId(0);
		sp.setNomeRegista("Alberto Angela");
		...
		System.out.println(attoreDAO.getSpettacoliInBolognaFromId(0, "protagonista"));
		
		try (PrintWriter pw = new PrintWriter("TEATRO.txt")){
			pw.println(attoreDAO.getSpettacoliInBolognaFromId(0, "protagonista"));
