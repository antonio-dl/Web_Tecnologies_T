...
public class GeneratoreRelazioniHibernate {
	public static void main(String[] args) {
		...
		String singular_1orM = "Struttura"; // RICORDATI LA MAIUSCOLA
		String plural_1orM = "Strutture"; // RICORDATI LA MAIUSCOLA

		// (1-N)N.B.: ^^^Questa^^^ puo' avere piu' di una di vvvquestavvv

		// Qui va il nome di N CON LA MAIUSCOLA!!!!!!
		String singular_N = "Esperienza"; // RICORDATI LA MAIUSCOLA
		String plural_N = "Esperienze"; // RICORDATI LA MAIUSCOLA
	...
	static private void genera_MtoN(String singular_M, String plural_M, String singular_N, String plural_N) { // WorkPackage(M)
		...
		System.out.println(
				"Set<" + singular_M + ">" + plural_M.toLowerCase() + " = new HashSet<" + singular_M + ">(5);\n");
