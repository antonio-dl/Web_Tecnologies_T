...
public class HIBERNATEgenerator 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		//CAMBIARE DA QUI...
		objName="Cucina"; //nome del bean (iniziale maiuscola!!)
		objPlural="Cucine"; //nome del bean in forma plurale (iniziale maiuscola!!)

		//non inserire "long id"!! (generato automaticamente)
		attr.add("String nome"); //coppie "tipo nome" separate da uno spazio
		attr.add("String regione"); //coppie "tipo nome" separate da uno spazio
		///...A QUI
